    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-borderless no-border">
                        ...
                        <tr>
                            ...
                            <td><?= $projectDetail->has('vendor') ? $this->Html->link($projectDetail->vendor->company_name, ['controller' => 'Vendors', 'action' => 'view', $projectDetail->vendor->id]) : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?= __('Sponsor') ?></th>
                            <td><?= $projectDetail->has('sponsor') ? $this->Html->link($projectDetail->sponsor->full_name, ['controller' => 'Sponsors', 'action' => 'view', $projectDetail->sponsor->id]) : '' ?>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless no-border">
                        ...
                        <tr>
                            ...
                            <td><?= h($projectDetail->has('personnel') ? $projectDetail->personnel->full_name : '') ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?= h($projectDetail->has('sub_status') ? $projectDetail->sub_status->lov_value : '') ?>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?= __('Priority') ?></th>
                            <td><?= h($projectDetail->has('priority') ? $projectDetail->priority->lov_value : '') ?>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td><?= $projectDetail->has('price') ? h($this->NumberFormat->format($projectDetail->price->budget, ['before' => isset($projectDetail->price->currency) ? $projectDetail->price->currency->symbol : ''])) : '0.00' ?>
                            </td>
                        </tr>
                        <tr>
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="#"><?= __('Activities') ?></a>
                </li>
                <li class="nav-item">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered dataTable" role="grid"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $activity->has('percentage_completion') ? $this->Number->format($activity->percentage_completion) . '%' : '0%' ?>
                        </td>
