                        ...
                        <div class="row">
                            ...
                            <div class="col px-4 py-4 top-box border-right">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 px-0">
                                        <div class="progress">
                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 50%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div id="chart-pie pt-0 pb-0">
                                                    <canvas id="<?= 'myBarChart' . $num ?>" style="height: 60px; width: auto"></canvas>
                                                </div>
                                                <?php
                                                    $total_percentage = 0;
                                                ...
                                                <script>
                                                    drawChart('<?= 'myBarChart' . $num ?>', <?=floor($total_percentage)?>);
                                                </script>
                                                <?php $num++ ?>
                                            </div>
                                            <div class="col mr-2">
