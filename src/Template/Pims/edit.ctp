...
<div class="container-fluid">
    ...
    <!-- <div class="text-center mb-3">a</div> -->
        <legend class="text-center mb-4"><?= __('Project Implementation Manual') ?></legend>
        <!-- my code  -->
    <!-- 0th Row  -->
    <div class="row justify-content-around">
            <div class="col-md-5 col-sm-12 card bat">
                ...
                <div class="form-group text">
                    ...
                    <div class="input-group"><input type="text" name="date" value=<?= $pim->date ?> class="form-control addon-right" empty="1" id="date" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="Brief" required="required" name="brief" ><?= $pim->brief ?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="oversight_level" name="oversight_level" value="<?= $pim->oversight_level ?>" required="required">
                </div>
                <div class="form-group">
                    <label for="oversight_agency_mda">Oversight Agency / MDA</label>
                    <input type="text" class="form-control" id="oversight_agency_mda" name="oversight_agency_mda" value="<?= $pim->oversight_agency_mda ?>" required="required">
                </div>
            </div>
            ...
            <legend class="text-primary">Project Components</legend>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="activity_next_semester" name ="activity_next_semester" required="required"><?= $pim->activity_next_semester ?></textarea>
                </div>
                <div class="form-group">
                    ...
                    <input type="number" id="total_expenditure" name="total_expenditure" value="<?= $pim->total_expenditure ?>"  class="form-control" required="required" aria-label="Amount (to the nearest naira)">
...
<!-- <div class="form-group">
    ...
    <input type="file" class="form-control" id="financial_template" name="financial_template" required="required">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="adopted_minutes" name="adopted_minutes" value="<?= $pim->adopted_minutes ?>" required="required">
                </div>
                <div class="form-group">
                    <label for="signed_mou">FINANCIAL MANAGEMENT DOCUMENT</label>
                    <input type="file" class="form-control" id="financial_management" name="financial_management" value="<?= $pim->financial_management ?>" required="required">
                </div>
                <div class="form-group">
                    <label for="signed_mou">FINANCIAL TEMPLATE DOCUMENT</label>
            ...
            <div class="col-md-5 col-sm-12 card bat">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="parties" name="parties" value="<?= $pim->parties ?>" required="required">
                </div>
                <div class="form-group">
                    <label for="responsibilities">Responsibilities</label>
                    <textarea class="form-control" id="responsibilities" name="responsibilities" required="required"><?= $pim->responsibilities ?></textarea>
                </div>
                <div class="form-group">
                    <div class="row justify-content-center">
                        <div class="col-md-5">
                        <label class="control-label" for="start_date">Start Date</label>
                            <div class="input-group"><input type="text" name="start_date" value="<?= $pim->start_date ?>" class="form-control addon-right" empty="1" id="start_date" autocomplete="off">
                            <span class="input-group-addon"><i class="fa fa-calendar fa-lg btn btn-outline-dark btn-md addon-right border-0"></i></span>
                            </div>
                        </div>
                        <div class="col-md-5">
                        <label class="control-label" for="end_date">End Date</label>
                            <div class="input-group"><input type="text" name="end_date" value="<?= $pim->end_date ?>" class="form-control addon-right" empty="1" id="end_date" autocomplete="off">
                            <span class="input-group-addon"><i class="fa fa-calendar fa-lg btn btn-outline-dark btn-md addon-right border-0"></i></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="financial_cost" name = "financial_cost" value="<?= $pim->financial_cost ?>" required = "required" class="form-control" aria-label="Amount (to the nearest naira)">
                    <div class="input-group-append">
                        <span class="input-group-text">.00</span>
                    </div>
                    </div>
...
<div class="row justify-content-around">
            ...
            <legend class="text-primary">Project Action Plan</legend>
                    <div class="form-group">
                            ...
                            <textarea class="form-control" id="activities" name="activities" required="required"><?= $pim->activities ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="Owner">Action</label>
                        <input type="text" class="form-control" id="action" name = "action" value="<?= $pim->action ?>" required = "required">
                    </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row justify-content-center">
                        ...
                        <label class="control-label" for="plan_start_date">Start Date</label>
                            <div class="input-group"><input type="text" name="plan_start_date" value="<?= $pim->plan_start_date ?>" class="form-control addon-right" empty="1" id="plan_start_date" autocomplete="off">
                            <span class="input-group-addon"><i class="fa fa-calendar fa-lg btn btn-outline-dark btn-md addon-right border-0"></i></span>
                            </div>
                        </div>
                        <div class="col-md-5">
                        <label class="control-label" for="plan_end_date">End Date</label>
                            <div class="input-group"><input type="text" name="plan_end_date" value="<?= $pim->plan_end_date ?>"class="form-control addon-right" empty="1" id="plan_end_date" autocomplete="off">
                            <span class="input-group-addon"><i class="fa fa-calendar fa-lg btn btn-outline-dark btn-md addon-right border-0"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="dependency" name="dependency" required="required"><?= $pim->dependency ?></textarea>
                    </div>
            </div>
            <div class="col-md-5 col-sm-12 card tab">
                <legend class="text-primary">Expenditure for output based disbursement</legend>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="owner" name = "owner" value="<?= $pim->owner ?>" required="required">
                        </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="disbursed_amount" name="disbursed_amount" type="number" value="<?= $pim->disbursed_amount ?>" required="required" class="form-control" aria-label="Amount (to the nearest naira)">
                        <div class="input-group-append">
                            <span class="input-group-text">.00</span>
                        </div>
                        </div>
                    ...
                    <div class="form-group text">
                        ...
                        <div class="input-group"><input type="text" name="exp_output_date" value="<?= $pim->exp_output_date ?>" class="form-control addon-right" empty="1" id="exp_output_date" autocomplete="off">
                        <span class="input-group-addon"><i class="fa fa-calendar fa-lg btn btn-outline-dark btn-md addon-right border-0"></i></span>
                        </div>
                    </div>
                </div>
            ...
            <!-- <div class="col-md-5 col-sm-12 card tab"> -->
                <!-- <legend class="text-primary">Progress Report</legend> -->
                    ...
                    <div class="form-group text">
                        ...
                        <div class="input-group"><input type="text" name="date_disbursement" value="<?= $pim->date_disbursement ?>" class="form-control addon-right" empty="1" id="date_disbursement" autocomplete="off">
                        <span class="input-group-addon"><i class="fa fa-calendar fa-lg btn btn-outline-dark btn-md addon-right border-0"></i></span>
                    </div>
                    <div class="form-group">
