<aside class="navbar navbar-nav bg-gradient-primary sidebar sidebar-dark sb" id="">
    ...
    <li class="dropdown nav-item">
        ...
        <li class="nav-item m-0">
            <?= $this->Html->link(
                __('<i class="fa fa-desktop fa-lg text-primary"></i> &nbsp;Progress Report'),
                ['controller' => 'ProjectDetails', 'action' => 'evaluation'],
                ['escape' => false, 'class' => 'nav-link collapsed collapsed text-primary my-0']
                ) ?>
        </li>
            <hr class="sidebar-divider m-0 bg-primary">
            <li class="nav-item">
                <?= $this->Html->link(
                    __('<i class="fa fa-archive fa-lg text-primary"></i> &nbsp;Consolidated Report'),
