...
<div class="milestones container-fluid">
    ...
    <fieldset>
        <legend><?= __('Add Milestones/Achievements') ?></legend>
        <div class="row">
            <div class="col-md-6">
                <?php
                    if($id == null)
                        ...
                        echo $this->Form->hidden('project_id', ['options' => [$id], 'default' => $id]);
                    echo $this->Form->control('description', ['type' => 'textarea']);
                    echo $this->Form->control('amount', ['min' => 0, 'prepend' => '<i class="addon-left">₦</i>', 'class' => 'addon-left']);
                    echo $this->Form->control('payment', ['required' => true, 'type' => 'checkbox']);
                ?>
            </div>
            <div class="col-md-6">
                <?php
...
//                echo $this->Form->control('project_id', ['options' => $projectDetails]);
//            else
//                echo $this->Form->control('project_id', ['options' => [$id], 'default' => $id, 'type' => 'hidden']);
