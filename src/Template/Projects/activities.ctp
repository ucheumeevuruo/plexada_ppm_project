...
<div class="container-fluid">
    ...
    <span aria-hidden="true" class=""><?= $this->Html->link(__('<i class="fa fa-plus fa-3x" aria-hidden="true"></i>'), ['controller' => 'activities','action' => 'add', $project->id], ['escape' => false, 'class' => 'btn btn-outline-primary btn-sm overlay']) ?></span>
    </div>
        ...
        <div class="py-3 pl-3 bg-default br-t">
            <div class="card-deck mb-3">
                ...
                <div class="card card-outline shadow">
                    <div class="card-body">
                    <span aria-hidden="true" class="edit-icon"><?= $this->Html->link(__('<i class="fa fa-pencil fa-sm"></i>'), ['controller' => 'activities','action' => 'edit',$activity->activity_id], ['escape' => false, 'class' => 'btn btn-outline-primary btn-sm overlay']) ?></span>
                        <p class="card-text">
