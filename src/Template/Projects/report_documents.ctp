...
<div class="container-fluid  mt-4">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <?= $this->Html->link('Summary', ['action' => 'report_implementation', $project->id], ['id' => 'transmit', 'class' => 'nav-link ']) ?>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <?= $this->Html->link('Gantt Chart', ['action' => 'report_gantt_chart', $project->id], ['id' => 'transmit', 'class' => 'nav-link']) ?>
        </li>
        <li class="nav-item">
