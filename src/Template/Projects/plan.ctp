    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <!-- <li>
                    &nbsp; /
                    <?= $this->Html->link(__('Indicators'), ['action' => 'monitorIndicators']) ?>
                </li>
                <li>
                    &nbsp; /
                    <?= $this->Html->link(__('Activities'), ['action' => 'monitorActivities']) ?>
                </li> -->
        ...
        <h3 class="text-primary text-left font-weight-bold mt-0">Select Plan </h3>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4" data-attr="">
                        <div class="card shadow py-0">
                            ...
                            <div class="card-footer no-gutters align-items-center py-0" style="background:#fff">
                                <div class="row">
                                    <div class="col-auto">
                                        <?= $this->Html->link(__('<i class="fas fa-edit fa-1x text-gray-300"></i>'), ['controller' => 'Plans', 'action' => 'edit', $plan->id], ['class' => 'overlay', 'escape' => false, 'title' => 'Edit Plan']) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
