...
<section id="flyby">
    <div class="container-fluid mt-4">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <?= $this->Html->link('Summary', ['action' => 'report_implementation', $project_id], ['id' => 'transmit', 'class' => 'nav-link']) ?>
            </li>
            <li class="nav-item">
                <?= $this->Html->link('Indicators', ['action' => 'report_milestones', $project_id], ['id' => 'transmit', 'class' => 'nav-link']) ?>
            </li>
            <li class="nav-item">
                <?= $this->Html->link('Activities', ['action' => 'activities', $project_id], ['id' => 'transmit', 'class' => 'nav-link active']) ?>
            </li>
            <li class="nav-item">
                <?= $this->Html->link('Disbursement', ['controller' => 'projects', 'action' => 'report_disburse', $project_id], ['id' => 'transmit', 'class' => 'nav-link']) ?>
            </li>
            <li class="nav-item">
                <?= $this->Html->link('Gantt Chart', ['action' => 'report_gantt_chart', $project_id], ['id' => 'transmit', 'class' => 'nav-link']) ?>
            </li>
            <li class="nav-item">
