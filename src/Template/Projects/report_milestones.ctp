...
<div class="container-fluid mt-4">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <?= $this->Html->link('Activities', ['action' => 'report_activities', $project_id], ['id' => 'transmit', 'class' => 'nav-link']) ?>
        </li>
        <li class="nav-item">
            <?= $this->Html->link('Disbursement', ['action' => 'report_disburse', $project_id], ['id' => 'transmit', 'class' => 'nav-link']) ?>
        </li>
        <li class="nav-item">
