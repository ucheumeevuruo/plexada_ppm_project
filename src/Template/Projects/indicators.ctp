...
<div class="container-fluid mt-4">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <?= $this->Html->link('Disbursements', ['action' => 'disburseSummary', $project_id], ['id' => 'transmit', 'class' => 'nav-link']) ?>
        </li>
        <!-- <li class="nav-item">
        ...
        <div class="row mx-0">
            <?php foreach ($milestones as $milestone) : ?>
                <div class="col-xl-3 col-md-6 mb-4" data-attr="<?= $this->Url->build(['controller' => 'milestones', 'action' => 'view', $project_id]) ?>">
                    <div <?php if ($milestone->status_id == 1) { ?> class="card border-left-light shadow py-0" <?php } else { ?> class="card border-left-dark shadow py-0" <?php } ?>>
                        <div class="card-body py-2 px-2">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2" id="clickable-sub-applet" data-attr="<?= $this->Url->build(['controller' => 'disbursements', 'action' => 'index', $milestone->id]) ?>">
