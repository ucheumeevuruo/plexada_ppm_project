...
<div class="sponsors form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <div class="row">
            <div class="col-md-6">
                <?= $this->Form->control('last_name', ['label' => ['class' => 'mandatory', 'text' => 'Organizational Name']]); ?>
                <?= $this->Form->hidden('first_name', ['label' => ['class' => 'mandatory', 'text' => 'Last Name / Organizational Othername']]); ?>
                <?= $this->Form->control('other_names', ['label' => 'Organization Contact Person']); ?>
