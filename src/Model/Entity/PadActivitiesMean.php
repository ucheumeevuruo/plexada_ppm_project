 ...
 * @property string $critical_assumptions
 * @property string|resource $pad_file
 *
 * @property \App\Model\Entity\Pad $pad
 */
class PadActivitiesMean extends Entity
{
    /**
