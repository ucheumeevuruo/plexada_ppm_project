...
/**
 * PadAchievements Model
 *
 * @property \App\Model\Table\PadsTable&\Cake\ORM\Association\BelongsTo $Pads
 *
 * @method \App\Model\Entity\PadAchievement get($primaryKey, $options = [])
 * @method \App\Model\Entity\PadAchievement newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\PadAchievement[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\PadAchievement|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\PadAchievement saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\PadAchievement patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\PadAchievement[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\PadAchievement findOrCreate($search, callable $callback = null, $options = [])
 */
class PadAchievementsTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('pad_achievements');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('critical assumptions')
            ->maxLength('critical assumptions', 120)
            ->requirePresence('critical assumptions', 'create')
            ->notEmptyString('critical assumptions');
