...
class DocumentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyDateTime('date_uploaded');

        $validator
            ->scalar('file_uploaded')
            ->maxLength('file_uploaded', 255)
            ->requirePresence('file_uploaded', 'create')
            ->notEmptyFile('file_uploaded');
