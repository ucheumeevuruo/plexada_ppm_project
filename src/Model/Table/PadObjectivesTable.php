 ...
 *
 * @method \App\Model\Entity\PadObjective get($primaryKey, $options = [])
 * @method \App\Model\Entity\PadObjective newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\PadObjective[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\PadObjective|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\PadObjective saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\PadObjective patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\PadObjective[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\PadObjective findOrCreate($search, callable $callback = null, $options = [])
 */
class PadObjectivesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->maxLength('critical_assumptions', 120)
