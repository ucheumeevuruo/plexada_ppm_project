...
class PlansFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'start_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'start_date' => '2020-05-26 00:09:43',
                'end_date' => '2020-05-26 00:09:43',
            ],
        ];
        parent::init();
    }
